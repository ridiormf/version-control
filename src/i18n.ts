  ...
  resources: {
    en: {
      translation: {
        ...
        pressEnterToFinish: "Press Enter to finish...",
        ...
        conventionalCommitHint:
          "Message must follow conventional commits: type(scope): description  e.g. feat(auth): add login",
    ...
    pt: {
      translation: {
        ...
        pressEnterToFinish: "Pressione Enter para finalizar...",
        ...
        conventionalCommitHint:
          "A mensagem deve seguir conventional commits: tipo(escopo): descrição  ex: feat(auth): adicionar login",
    ...
    es: {
      translation: {
        ...
        pressEnterToFinish: "Presione Enter para finalizar...",
        ...
        conventionalCommitHint:
          "El mensaje debe seguir conventional commits: tipo(alcance): descripción  ej: feat(auth): agregar login",
    ...
    fr: {
      translation: {
        ...
        pressEnterToFinish: "Appuyez sur Entrée pour terminer...",
        ...
        conventionalCommitHint:
          "Le message doit suivre conventional commits: type(portée): description  ex: feat(auth): ajouter login",
